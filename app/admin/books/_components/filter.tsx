...
const filters: { label: string; symbol: string; icon: LucideIcon }[] = [
  { label: "A-Z", symbol: "az", icon: ArrowDownIcon },
  { label: "Z-A", symbol: "za", icon: ArrowUpIcon },
  { label: "Newest", symbol: "newest", icon: ArrowDownIcon },
  { label: "Oldest", symbol: "oldest", icon: ArrowUpIcon },
];
